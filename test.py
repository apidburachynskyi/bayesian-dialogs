...
if __name__=='__main__': 
  ...
  parser.add_argument('-n_tests', type=int, default=10, help='Number of simulations test to run (number of needs).')
  parser.add_argument('-N_min', type=int, default=10, help='Minimum value for N, the size of the universe.')
  parser.add_argument('-N_max', type=int, default=155, help='Maximum value for N, the size of the universe.')
  parser.add_argument('-print_average_length', type=bool, default=False, help='Print the average length (in terms of number of iterations) of the runs.')
  ...
  dic_iteration = {}
  for N in range(args.N_min,args.N_max): # N corresponds to the size of the universe here.
  ...
  if args.print_average_length is True :
    print(f'Average length of the runs per value of N (universe size), over {args.n_tests} seeds: {dic_iteration}')
