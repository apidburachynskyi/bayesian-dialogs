...
class posterior_probability_computation :
  ...
  def run(self):
    ...
    return list_qt_alpha_proba, list_qt_beta_proba, len(self.joint_partition([partition_alpha],self.join_initial_partition)), t
  ...
  def visualisations(self,list_qt_alpha_proba, list_qt_beta_proba) :
    ...
    fig.savefig('results/posterior_probabilities.png')
...
def main_run(partition_1, partition_2, A, w, visualisations = True) :
  ...
  my_experiment = posterior_probability_computation(partition_1=partition_1,partition_2=partition_2,A=A,w=w)
...
if __name__=='__main__': 
    ...
    main_run(partition_1=data['partition_1'],partition_2=data['partition_2'],A=data['A'],w=data['w'],visualisations=True)
